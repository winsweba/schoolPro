...
import 'package:nm/screens/cleanupscreen/proceedtopayment.dart';
...
class CleanupDetails extends StatefulWidget {

  final String cleanupName; //TODO Add  this

  CleanupDetails(this.cleanupName,); //TODO Add  this


  @override
  _CleanupDetailsState createState() => _CleanupDetailsState();
}

class _CleanupDetailsState extends State<CleanupDetails> {
