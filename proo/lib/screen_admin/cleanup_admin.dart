...
class CleanupAdminScreen extends StatefulWidget {
  @override
  _CleanupAdminScreenState createState() => _CleanupAdminScreenState();
}

class _CleanupAdminScreenState extends State<CleanupAdminScreen> {
  ...
  void saveUserData() {
    Map<String, dynamic> userData = {
      'cleanupName' : _comNameTextEditingController.text.trim(),
    ...
    FirebaseFirestore.instance.collection('cleanup').doc().set(userData);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Clean up'),),
