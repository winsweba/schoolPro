...
class CarAdminScreen extends StatefulWidget {
  @override
  _CarAdminScreenState createState() => _CarAdminScreenState();
}
...
class _CarAdminScreenState extends State<CarAdminScreen> {
  ...
  void saveUserData() {
    Map<String, dynamic> userData = {
      'washingBayName' : _comNameTextEditingController.text.trim(),
    ...
    FirebaseFirestore.instance.collection('washingbay').doc().set(userData);
  }
